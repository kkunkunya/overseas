...
1. 找 3–5 个规模足以产生真实讨论、且日/周/月增长可解释的候选社区；
2. 检查真实活跃度，不把成员数、点赞或单次新闻爆发直接当需求；
3. 只在满足“同一类人 + 相似场景/任务 + 相似替代方案”时归为一个 audience；主题相近但任务不同的社区不要硬合并；
4. 从 pain & anger、advice requests、solution requests 各抽少量代表性内容，并回原帖核查；
5. 补充教育型创作者的热门内容与评论，提取用户语言和潜在分发入口；
6. 用 `assets/audience-opportunity-card.md` 写出一个**人群问题簇**，再把用户原话翻译为候选词群。
